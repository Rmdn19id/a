...
1. File Description
2. Driver Installation for Windows XP and Windows Server 2003 
...
ipfnd51.sys           driver file

fSet.exe            Auto-install utility for Windows driver
...
------------------------------------------------
    ...
    fSet.exe utility in the Adapter Drivers Diskette/CD-ROM.

     a. Make sure fSet.exe utility with all driver files in same folder.

     b. Run fSet.exe directly. Then the screen will display :
