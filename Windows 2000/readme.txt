...
1. File Description
2. Driver Installation for Windows 2000
...
ipfnd5.sys            Windows 2000 NDIS 5 driver

fSet2K.exe            Auto-install utility for Windows 2000 NDIS 5 driver
...
------------------------------------------------
    ...
    fSet2K.exe utility in the Adapter Drivers Diskette/CD-ROM.

     a. Make sure fSet2K.exe utility with all driver files in same folder.

     b. Run fSet2K.exe directly. Then the screen will display :
