...
1. File Description
2. Driver Installation for Windows 98Sec
...
ipfnd5.sys            Windows 98Sec NDIS 5 driver

fSet98B.exe           Auto-install utility for Windows 98Se NDIS 5 driver
...
------------------------------------------------
    ...
    fSet98B.exe utility in the Adapter Drivers Diskette/CD-ROM.

     a. When OS pops a window asking for the driver for a PnP device, 
        do not apply any driver for it, click on Cancel.

     b. Make sure fSet98B.exe utility with all driver files in same folder.

     c. Run fSet98B.exe directly. 

     d. Reboot the computer.
     
     e. Put in Windows 98Sec CD-ROM for the OS to configure the Adapter.
...
------------------------
   - Open 'Device Manager' in "My Computer" -> "Control Pannel" ->
     ...
     Double click "TP-LINK TF-3200 10/100 Fast Ethernet Adapter", Select 
     "Advanced" item.
