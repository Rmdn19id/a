...
1. File Description
2. Driver Installation for Windows ME
...
ipfnd5.sys            Windows ME NDIS 5 driver

fSetME.exe            Auto-install utility for Windows Me NDIS 5 driver
...
------------------------------------------------
    ...
    fSetME.exe utility in the Adapter Drivers Diskette/CD-ROM.

     a. Make sure fSetME.exe utility with all driver files in same folder.

     b. Run fSetME.exe directly. Then the screen will display :
